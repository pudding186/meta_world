...
public:
    ...
    public:
        ...
        iterator(void *dataarray, long long index)
            :
            m_index(index),
        ...
        {
            if (m_dataarray != ite.m_dataarray)
            {
                return true;
            }
        ...
        T operator*(void)
        {
            ...
            return (*(DataArray<T, U, N, true, true> *)m_dataarray)[(U)m_index];
        }
...
public:
    ...
    iterator end(void) const
    {
        ...
        return iterator((void*)this, m_size);
    }
...
public:
    ...
    public:
        ...
        T operator*(void)
        {
            ...
            return (*(DataArray<T, U, N, false, true> *)m_dataarray)[(U)m_index];
        }
