...
#define DEFAULT_DATAARRAY_SIZE 15
...
public:
    ...
    void push_back(const T& val)
    {
        ...
        {
            if ((m_max_capcity - m_capacity) < m_capacity/2)
            {
...
public:
    ...
    void push_back(const T& val)
    {
        ...
        {
            if (m_max_capacity - m_capacity < m_capacity/2)
            {
